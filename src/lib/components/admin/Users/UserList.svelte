...
> 
> Graden IA is completely free to use as-is, with no restrictions or hidden limits, and we'd love to keep it that way. 🌱  
>
...
> 
> - 👉 **[Click here to learn more about enterprise licensing](https://github.com/grandelagbanou28-gif/GrdenIA)**
> - 👉 *[Click here to sponsor the project on GitHub](https://github.com/grandelagbanou28-gif/GrdenIA)*
`}
			/>
		</div>
	{/if}
