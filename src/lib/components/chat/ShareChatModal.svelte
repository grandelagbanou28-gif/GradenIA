<script lang="ts">
	...
	const shareChat = async () => {
		...
		toast.success($i18n.t('Redirecting you to Graden IA Community'));
		const url = 'https://github.com/grandelagbanou28-gif/GradenIA';
			...
			<div class="px-5 pt-4 pb-5 w-full flex flex-col">
				...
				<div class="flex justify-end gap-1 mt-3">
					{#if $config?.features.enable_community_sharing}
						...
						>
							{$i18n.t('Share to Graden IA Community')}
						</button>
					{/if}
