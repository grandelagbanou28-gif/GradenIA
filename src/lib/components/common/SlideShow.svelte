<script lang="ts">
	...
	export let imageUrls = [
		`${WEBUI_BASE_URL}/assets/images/code.jpg`,
		`${WEBUI_BASE_URL}/assets/images/hacker.jpg`,
		`${WEBUI_BASE_URL}/assets/images/terminal.jpg`,
		`${WEBUI_BASE_URL}/assets/images/ai.jpg`
	];
